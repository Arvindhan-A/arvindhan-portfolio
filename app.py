...
projects = [
    ...
    },
    {
        ...
        "name": "Gaia Cloud",
        "tag": "PLATFORM",
        "image": "gaia_cloud.png",
        "url": "https://cloud.gaiasentinel.online",
        "desc": "Deploy Flask, Django, Node apps in under 60 seconds. Spin up PostgreSQL instantly. No DevOps.",
        "long_desc": "I got tired of spending 2 hours configuring servers for a 10-minute feature. Every developer knows this pain. Nginx configs, environment files, Docker Compose — all before you've written a single line of app code.\n\nGaia Cloud fixes this. Push your GitHub repo, it auto-detects the framework (Flask, Django, FastAPI, Express, Next.js, or static HTML), provisions a Docker container with cgroup isolation, spins up a PostgreSQL database with full credentials, and gives you a free yourapp.gaiasentinel.online subdomain. Five clicks. Under 60 seconds.\n\nNo cold starts on the free tier. Real-time CPU, memory, disk, and bandwidth monitoring. Auto-restart on crash. Pricing is in INR and predictable — no usage spikes. Free tier gives you 2 web services and 1 database. Starter is ₹349/month.",
        "features": [
            "Auto-detection of 6 frameworks — Flask, Django, FastAPI, Express, Next.js, static HTML",
            "Instant PostgreSQL provisioning — isolated databases, full credentials in seconds",
            "Free subdomain on gaiasentinel.online for every deployment",
            "Resource isolation with cgroups — no shared process space",
            "Live deploy logs in real-time",
            "Auto-restart on crash (3 restarts on free plan, unlimited on paid)",
            "Secrets vault for environment variables",
        ],
        "pricing": [
            "Free — 2 services, 1 DB, 0.5 CPU, 512MB RAM, 1.5GB storage",
            "Starter ₹349/mo — 5 services, 3 DBs, 1 CPU, 1GB RAM, 5GB storage",
            "Pro ₹1499/mo — 15 services, 10 DBs, 4 CPU, 4GB RAM, 30GB storage",
            "Business ₹3599/mo — 50 services, 25 DBs, 8 CPU, 16GB RAM, 100GB storage",
        ],
        "tech": ["Python", "Docker", "PostgreSQL", "Nginx", "cgroups", "GitHub API"],
        "role": "Backend architecture, deployment pipeline",
...
skills = [
    {
        ...
        "used_in": ["gaia-sentinel", "gaia-cloud", "c12-tracker"],
    ...
    },
    {
        ...
        "used_in": ["gaia-sentinel", "gaia-cloud", "gaia-transfer"],
